...
public class AdoptPagination {
	...
	private int pageSize = 8;		// 보여질 페이지 번호 개수
	...
	// 기본 생성자 X
	public AdoptPagination(int currentPage, int listCount) {
		super();
	...
	public AdoptPagination(int currentPage, int listCount, int limit, int pageSize) {
		super();
		this.currentPage = currentPage;
		this.listCount = listCount;
		this.limit = limit;
	...
	public String toString() {
		return "AdoptPagination [currentPage=" + currentPage + ", listCount=" + listCount + ", limit=" + limit
