...
/* FleaPagination 뜻 : 목록을 일정 페이지로 분할해서
 * 				   원하는 페이지를 볼 수 있게 하는 것
 * 				 	== 페이징 처리
 * 
 * FleaPagination 객체 : 페이징 처리에 필요한 값을 모아두고, 계산하는 객체
 */
...
public class BoardPagination {
	...
	public String toString() {
		return "FleaPagination [currentPage=" + currentPage + ", listCount=" + listCount + ", limit=" + limit
