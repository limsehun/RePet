...
public class FleaPagination {
    ...
    private int limit = 10;			// 한 페이지 목록에 보여지는 게시글 수 (5개씩 2줄)
    ...
    public FleaPagination(int currentPage, int listCount) {
        super();
    ...
    public FleaPagination(int currentPage, int listCount, int limit, int pageSize) {
        super();
        this.currentPage = currentPage;
        this.listCount = listCount;
        this.limit = limit;
